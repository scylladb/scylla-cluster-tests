...
class LWTLongevityTest(LongevityTest):
    ...
    def run_prepare_write_cmd(self):
        ...
        if self.db_cluster.nemesis_count > 1:
            ...
            DataValidatorEvent.DataValidator(severity=Severity.NORMAL, message="Test runs with parallel nemesis. Data validator is disabled.").publish()
        else:
            self.data_validator = LongevityDataValidator(longevity_self_object=self, user_profile_name="c-s_lwt", base_table_partition_keys=self.BASE_TABLE_PARTITION_KEYS)
