        ...
        with (
            ...
            try:
                ...
                try:  # So that the nemesis thread won't stop due to elasticsearch failure
                    ...
                    self.log.warning(f"Connection timed out when attempting to update elasticsearch statistics:\n{err}")
                except Exception as err:  # noqa: BLE001
                    self.log.warning(f"Unexpected error when attempting to update elasticsearch statistics:\n{err}")
