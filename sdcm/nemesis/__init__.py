...
||||||| parent of 3213ecaac (refactor(nemesis): extract 6 network disruption monkeys into network.py)
    def get_rate_limit_for_network_disruption(self) -> Optional[str]:
        if not self.monitoring_set.nodes:
            return None
...
=======
>>>>>>> 3213ecaac (refactor(nemesis): extract 6 network disruption monkeys into network.py)
