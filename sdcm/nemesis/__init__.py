...
||||||| parent of fe343c071 (fix(nemesis): prevent "No partitions for deletion found" error in DeleteByRowsRange)
        self._init_num_deletions_factor()
=======
        self._init_partition_deletion_divisor()
>>>>>>> fe343c071 (fix(nemesis): prevent "No partitions for deletion found" error in DeleteByRowsRange)
