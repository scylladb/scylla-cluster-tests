...
class ClusterTester(db_stats.TestStatsMixin, unittest.TestCase):
    ...
    def get_cluster_gce(self, loader_info, db_info, monitor_info):  # noqa: PLR0912, PLR0914
        zones = self.params.get("gce_datacenter").split()
        ...
        if db_type == "cloud_scylla":
            ...
            self.db_cluster = ScyllaGCECluster(
                image_id=gce_image,
                root_disk_size=db_info.get("disk_size") or self.params.get("root_disk_size_db"),
        ...
        self.loaders = LoaderSetGCE(
            image_id=self.params.get("gce_image_loader"),
            root_disk_size=loader_info.get("disk_size") or self.params.get("root_disk_size_loader"),
            instance_type=loader_info.get("type") or self.params.get("gce_instance_type_loader"),
            provisioners=provisioners,
        ...
        if monitor_info["n_nodes"] > 0:
            ...
            self.monitors = MonitorSetGCE(
                ...
                instance_type=monitor_info.get("type") or self.params.get("gce_instance_type_monitor"),
                root_disk_size=monitor_info.get("disk_size") or self.params.get("root_disk_size_monitor"),
                provisioners=provisioners,
