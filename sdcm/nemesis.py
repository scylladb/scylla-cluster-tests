...
class Nemesis:  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    ...
    def _nemesis_stress_failure_handler(self, results, errors):
        """Handler for stress thread during nemesis - aborts the nemesis if a stress command failed on all loaders"""
