...
class Nemesis(NemesisFlags):
    ...
    def _manager_backup_and_report(self, object_storage_transfer_method: ObjectStorageUploadMode, label) -> BackupTask:
        """
        Run a backup using Scylla Manager and report the result to Argus.

        :param object_storage_transfer_method: The transfer mode for object storage (e.g., RCLONE or NATIVE).
