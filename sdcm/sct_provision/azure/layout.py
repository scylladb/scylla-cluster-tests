...
from sdcm.sct_provision.azure.cluster import OracleDBCluster, DBCluster, LoaderCluster, MonitoringCluster
from sdcm.sct_provision.common.layout import SCTProvisionLayout
from sdcm.test_config import TestConfig


class SCTProvisionAzureLayout(SCTProvisionLayout, cluster_backend='azure'):
