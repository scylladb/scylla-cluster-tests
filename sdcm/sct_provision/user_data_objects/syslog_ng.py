...
from sdcm.provision.common.utils import configure_syslogng_target_script, restart_syslogng_service, install_syslogng_exporter, configure_syslogng_destination_conf
...
class SyslogNgUserDataObject(SctUserDataObject):
    ...
    def script_to_run(self) -> str:
        ...
        script = configure_syslogng_destination_conf(host=host, port=port, throttle_per_second=SYSLOGNG_LOG_THROTTLE_PER_SECOND)
