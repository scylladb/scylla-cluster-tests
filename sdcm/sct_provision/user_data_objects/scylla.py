...
class ScyllaUserDataObject(SctUserDataObject):
    ...
    def scylla_machine_image_json(self) -> str:
        ...
        smi_payload = {"start_scylla_on_first_boot": False, "data_device": data_device, "raid_level": self.params.get("raid_level") or 0, "scylla_yaml": scylla_yaml.model_dump(exclude_defaults=True, exclude_none=True, exclude_unset=True)}
