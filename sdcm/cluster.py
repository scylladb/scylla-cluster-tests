...
from cassandra.cluster import ConnectionShutdown, ControlConnectionQueryFallback, NoHostAvailable
...
from sdcm.utils.sct_agent_installer import DEFAULT_AGENT_CERTS_DIR, reconfigure_agent_script
