...
class BaseCluster:
    ...
    def add_nodes(
        self, count, ec2_user_data="", dc_idx=0, rack=0, enable_auto_bootstrap=False, instance_type=None, ami_id=None
    ):
        """
        ...
        :param ami_id: AMI ID to use, can override what's defined in configuration
