...
class SlaUtils:
        ...
        for node in db_cluster.nodes:
            ...
            if not scheduler_runtime_per_sla:
                ...
                WorkloadPrioritisationEvent.EmptyPrometheusData(
                    message=f"Failed to get scheduler_runtime data from Prometheus for node {node_ip}",
            ...
            if not expected_ratio:
                ...
                result.append(
                    self.validate_runtime_relatively_to_share(
    ...
    @staticmethod
    def validate_runtime_relatively_to_share(
