...
class Steps(SlaUtils):
    ...
    def run_stress_and_validate_scheduler_runtime_during_load(
    ...
    # pylint: disable=too-many-arguments
    def alter_sl_and_validate_scheduler_runtime(
        ...
        with TestStepEvent(
            ...
            try:
                ...
                with adaptive_timeout(
                    ...
                    node=tester.db_cluster.nodes[0],
                    timeout=15,
    ...
    # pylint: disable=too-many-arguments
    def attach_sl_and_validate_scheduler_runtime(
        self,
        tester,
        new_service_level,
        role_for_attach,
        ...
        with TestStepEvent(
            ...
            f"Validate scheduler runtime during load"
        ) as wp_event:
            try:
                ...
                if restart_scylla:
                    nodes_for_restart = [
                        ...
                        if node.jmx_up() and node.db_up() and not node.running_nemesis
                    ]
...
class SlaTests(Steps):
    ...
    def test_increase_shares_by_attach_another_sl_during_load(
        ...
        with tester.db_cluster.cql_connection_patient(
            ...
            try:
                error_events.append(
                    self.run_stress_and_validate_scheduler_runtime_during_load(
                        tester=tester,
                        read_cmds=read_cmds,
                        prometheus_stats=prometheus_stats,
                ...
                error_events.append(
                    self.attach_sl_and_validate_scheduler_runtime(
                        tester=tester,
    ...
    def test_increase_shares_during_load(
        ...
        with tester.db_cluster.cql_connection_patient(
            ...
            try:
                ...
                error_events.append(
                    self.alter_sl_and_validate_scheduler_runtime(
                        tester=tester,
