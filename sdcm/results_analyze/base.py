...
class ClassBase:
    ...
    def load_kwargs(self, kwargs):
        ...
        if errors:
            raise ValueError(f"Following errors occurred during class {self.__class__.__name__} initialization: \n" + "\n".join(errors))
    ...
    def _iterate_data(self, callback, data_path=None, es_data_path=None):
        ...
        while instances:
            ...
            for data_name, data_instance in current_instance.__dict__.items():
                ...
                if not isinstance(data_instance, ClassBase) or data_instance.__class__.load_from_es_data is not ClassBase.load_from_es_data:
