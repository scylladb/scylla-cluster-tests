...
class MetricBase(ClassBase):
    ...
    def rdiff(self, other, name=None):
        ...
        return MetricRelativeDiffBase(base_value=self.value, other_value=other.value, inverted_betterness=self.inverted_betterness, name=name)
    ...
    def rate(self, other, name=None):
        ...
        return MetricRateDiffBase(base_value=self.value, other_value=other.value, inverted_betterness=self.inverted_betterness, name=name)
