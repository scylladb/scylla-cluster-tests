...
class GrafanaScreenShot(GrafanaEntity):
    ...
    def dashboards(self) -> list:
        """The static dashboards plus any panels configured via `grafana_screenshot_panels`."""
        return list(self.grafana_dashboards) + list(self._params.get("grafana_screenshot_panels") or [])
        ...
        try:
            for dashboard in self.dashboards:
                try:
                    ...
                    # a whole dashboard is rendered at full height (height=-1), a single panel at its own
                    request_params: dict = {"width": dashboard.resolution[0], "height": -1}
                    ...
                    if dashboard.panel_title:
                        ...
                        request_params["height"] = dashboard.resolution[1]
