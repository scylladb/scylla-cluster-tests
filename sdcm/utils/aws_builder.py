        ...
        if launch_template_data.get("LaunchTemplateData") != curr_launch_template_data:
            try:
                ...
                self.region.client.modify_launch_template(
                    LaunchTemplateName=self.launch_template_name, DefaultVersion=str(version_number)
                )
    ...
    def create_launch_template(self):
        ...
        try:
            self.region.client.create_launch_template(
                LaunchTemplateName=self.launch_template_name, **self.get_launch_template_data(runner)
            )
        except botocore.exceptions.ClientError as error:
            LOGGER.debug(error.response)
        ...
        try:
            ...
            asg_client.create_auto_scaling_group(
                ...
                Tags=[
                    ...
                    {"Key": "BillingProject", "Value": "?????", "PropagateAtLaunch": True},
