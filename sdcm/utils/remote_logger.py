...
class CertManagerLogger(CommandClusterLoggerBase):
    ...
    def _logger_cmd(self) -> str:
        cmd = self._cluster.kubectl_cmd(
            f"logs --previous=false -f --since={int(self.time_delta)}s --all-containers=true -l app.kubernetes.io/instance=cert-manager",
...
class ScyllaManagerLogger(CommandClusterLoggerBase):
    ...
    def _logger_cmd(self) -> str:
        cmd = self._cluster.kubectl_cmd(
            f"logs --previous=false -f --since={int(self.time_delta)}s --all-containers=true -l app.kubernetes.io/instance=scylla-manager",
...
class ScyllaOperatorLogger(CommandClusterLoggerBase):
    ...
    def _logger_cmd(self) -> str:
        cmd = self._cluster.kubectl_cmd(
            f"logs --previous=false -f --since={int(self.time_delta)}s --all-containers=true -l app.kubernetes.io/instance=scylla-operator",
...
class HaproxyIngressLogger(CommandClusterLoggerBase):
    ...
    def _logger_cmd(self) -> str:
        cmd = self._cluster.kubectl_cmd(
            f"logs --previous=false -f --since={int(self.time_delta)}s --all-containers=true -l app.kubernetes.io/name=haproxy-ingress",
