...
class File:
    ...
    def __init__(self, path: str, mode: str = "r", buffering: Optional[int] = None, encoding: Optional[str] = None, errors: Optional[str] = None, newline: Optional[str] = None, closefd: bool = True):
        self.path = path
        self.mode = mode
    ...
    def _open(self) -> TextIO:
        kwargs = {attr_name: getattr(self, attr_name) for attr_name in ["mode", "buffering", "encoding", "errors", "closefd"] if getattr(self, attr_name, None) is not None}
