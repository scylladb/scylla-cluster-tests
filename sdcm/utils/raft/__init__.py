    ...
    def check_group0_tokenring_consistency(
        ...
        try:
            ...
            valid_tokenring_members = [
                member for member in tokenring_members 
                if member.host_id is not None and member.ip_address is not None
            ]
            ...
            error_message = (
                f"Node {self._node.name} failed to check group0/token-ring consistency: "
