...
class AutoSshContainerMixin:
    ...
    def auto_ssh_container_run_args(self, local_port, remote_port, ssh_mode="-R"):
        ...
        return dict(
            ...
            environment=dict(SSH_HOSTNAME=hostname, SSH_HOSTPORT=port, SSH_HOSTUSER=user, SSH_TUNNEL_HOST="127.0.0.1", SSH_MODE=ssh_mode, SSH_TUNNEL_LOCAL=local_port, SSH_TUNNEL_REMOTE=remote_port, AUTOSSH_GATETIME=0),
            network_mode="host",
