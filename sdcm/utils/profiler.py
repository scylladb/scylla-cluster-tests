...
class ProfilerFactory:
    ...
    def get_profile(self, group_name, is_process=False):
        if is_process:
            profile = ProcessProfile(timer=self._timer, subcalls=self._subcalls, builtins=self._builtins, group_name=group_name)
        else:
            profile = ThreadProfile(timer=self._timer, subcalls=self._subcalls, builtins=self._builtins, group_name=group_name)
