...
from typing import TYPE_CHECKING, Any, Callable, Dict, Iterable, List, Literal, Optional, Type, Union
...
def download_and_unpack_logs(test_id: str, log_type: str, download_to: str = None) -> str:
    ...
    # circular import: restore.py imports from utils.common
    from sdcm.monitorstack.restore import extract_file_from_tar_archive  # noqa: PLC0415
