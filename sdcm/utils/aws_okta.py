...
def can_get_to_aws_account():
    ...
    try:
        ...
        # Pin real STS explicitly: under minicloud the global AWS_ENDPOINT_URL override
        # would otherwise redirect this credential probe to the emulator, which cannot
