...
class NetworkSecurityGroupProvider:
    ...
    def __post_init__(self):
        ...
        try:
            ...
            for group in groups:
                sec_group = self._azure_service.network.network_security_groups.get(self._resource_group_name, group.name)
    ...
    def get_or_create(self, security_rules: Iterable, name="default") -> NetworkSecurityGroup:
        ...
        LOGGER.info("Provisioned security group %s in the %s resource group", network_sec_group.name, self._resource_group_name)
