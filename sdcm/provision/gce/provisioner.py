...
class GceProvisioner(Provisioner):
    ...
    def run_command(self, name: str, command: str) -> Result:
        ...
        print(
            f"VM instance {vm_instance.user_name}: public ip {vm_instance.public_ip_address}, private ip {vm_instance.private_ip_address}"
        )
        ...
        print(f"Instance {vm_instance.user_name}, ssh login info: {ssh_login_info}")
    ...
    def _gce_instance_to_vm_instance(self, gce_instance: compute_v1.Instance) -> VmInstance:
        ...
        print(f"Extracted user_name={user_name}, ssh_key_name={ssh_key_name} from tags")
