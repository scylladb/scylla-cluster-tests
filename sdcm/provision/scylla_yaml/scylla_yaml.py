...
from sdcm.provision.scylla_yaml.auxiliaries import EndPointSnitchType, ServerEncryptionOptions, ClientEncryptionOptions, SeedProvider, RequestSchedulerOptions
...
class ScyllaYaml(BaseModel):
    ...
    request_scheduler: Literal["org.apache.cassandra.scheduler.NoScheduler", "org.apache.cassandra.scheduler.RoundRobinScheduler"] | None = None
    ...
    authenticator: Literal["org.apache.cassandra.auth.PasswordAuthenticator", "org.apache.cassandra.auth.AllowAllAuthenticator", "com.scylladb.auth.TransitionalAuthenticator", "com.scylladb.auth.SaslauthdAuthenticator"] | None = (
    ...
    authorizer: Literal["org.apache.cassandra.auth.AllowAllAuthorizer", "org.apache.cassandra.auth.CassandraAuthorizer", "com.scylladb.auth.TransitionalAuthorizer", "com.scylladb.auth.SaslauthdAuthorizer"] | None = (
    ...
    alternator_write_isolation: Literal["unsafe_rmw", "only_rmw_uses_lwt", "forbid_rmw", "always_use_lwt"] = None  # None
    ...
    def diff(self, other: "ScyllaYaml") -> str:
        self_str = yaml.safe_dump(self.model_dump(exclude_defaults=True, exclude_unset=True, exclude_none=True)).splitlines(keepends=True)
        other_str = yaml.safe_dump(other.model_dump(exclude_defaults=True, exclude_unset=True, exclude_none=True)).splitlines(keepends=True)
