...
class ScyllaYamlAttrBuilderBase(AttrBuilder):
    ...
    @property
    def _default_endpoint_snitch(self) -> Literal["org.apache.cassandra.locator.Ec2MultiRegionSnitch", "org.apache.cassandra.locator.GossipingPropertyFileSnitch", "org.apache.cassandra.locator.Ec2Snitch"]:
