...
class InstanceProvisionerBase(BaseModel, metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    def provision(self, provision_parameters: ProvisionParameters, instance_parameters: InstanceParamsBase | List[InstanceParamsBase], count: int, tags: Union[List[TagsType], TagsType] = None, names: List[str] = None) -> List[Any]:
        pass
