...
class CassandraHarryThread(DockerBasedStressThread):
    ...
    def _run_stress(self, loader, loader_idx, cpu_idx):
        ...
        with (
            CassandraHarryStressExporter(instance_name=loader.ip_address, metrics=nemesis_metrics_obj(), stress_operation="write", stress_log_filename=log_file_name, loader_idx=loader_idx),
            ...
            try:
                ...
                harry_finish_event = CassandraHarryEvent.finish(node=loader, stress_cmd=self.stress_cmd, log_file_name=log_file_name)
