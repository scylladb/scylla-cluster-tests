...
class FullscanOperationBase:
    ...
    def cql_connection(self, **kwargs):
        ...
        with self.fullscan_params.db_cluster.cql_connection_patient(
            node=node, user=self.fullscan_params.user, password=self.fullscan_params.user_password, **kwargs
        ) as session:
...
class FullScanAggregatesOperation(FullscanOperationBase):
    ...
    def _validate_fullscan_result(self, cmd_result: ResultSet, validate_mapreduce_service_requests_start_time):
        ...
        try:
            ...
            return (
                "Fullscan failed - 'mapreduce_service_requests_dispatched_to_other_nodes' was not triggered",
                severity,
            )
    ...
    def validate_mapreduce_service_requests_dispatched_to_other_nodes(self, start_time):
        ...
        prometheus_mapreduce_service_requests = prometheus.query(
            "scylla_mapreduce_service_requests_dispatched_to_other_nodes", start_time, time.time()
        )
