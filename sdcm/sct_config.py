...
class SCTConfiguration(dict):
    ...
    config_options = [
        ...
        dict(name="alternator_table_name", env="SCT_ALTERNATOR_TABLE_NAME", type=str,
             help="The name of the table to create"),
        dict(name="alternator_table_lsi_name", env="SCT_ALTERNATOR_TABLE_LSI_NAME", type=str,
             help="The name of the local secondary index to create with a table"),
        dict(name="alternator_table_gsi_name", env="SCT_ALTERNATOR_TABLE_GSI_NAME", type=str,
             help="The name of the global secondary index to create with a table"),
        dict(name="alternator_table_tags", env="SCT_ALTERNATOR_TABLE_TAGS", type=dict,
             help="The tags to apply to the created table"),
