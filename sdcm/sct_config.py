...
class SCTConfiguration(dict):
    ...
    config_options = [
        ...
        dict(name="vs_cpu_limit", env="SCT_VS_CPU_LIMIT", type=float,
             help="CPU limit (cores) for vector store nodes"),

        dict(name="vs_memory_limit", env="SCT_VS_LIMIT", type=str,
             help="Memory limit for vector store nodes"),
    ]
