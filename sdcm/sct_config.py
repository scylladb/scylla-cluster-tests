...
class SCTConfiguration(dict):
    ...
    config_options = [
        ...
        dict(name="oci_instance_type_loader", env="SCT_OCI_INSTANCE_TYPE_LOADER", type=str, help=""),
        dict(name="oci_instance_type_monitor", env="SCT_OCI_INSTANCE_TYPE_MONITOR", type=str, help=""),
        dict(name="oci_instance_type_db", env="SCT_OCI_INSTANCE_TYPE_DB", type=str, help=""),
        dict(name="oci_instance_type_db_oracle", env="SCT_OCI_INSTANCE_TYPE_DB_ORACLE", type=str, help=""),
        dict(name="oci_image_db", env="SCT_OCI_IMAGE_DB", type=str, help=""),
        dict(name="oci_image_monitor", env="SCT_OCI_IMAGE_MONITOR", type=str, help=""),
        dict(name="oci_image_loader", env="SCT_OCI_IMAGE_LOADER", type=str, help=""),
        dict(name="oci_image_username", env="SCT_OCI_IMAGE_USERNAME", type=str, help=""),
        # k8s-eks options
