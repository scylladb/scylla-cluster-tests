...
class SCTConfiguration(dict):
    ...
    def cloud_provider_params(self) -> dict:
        ...
        if cloud_provider == "aws":
            return {"region": self.region_names[0], "instance_type_db": self.get("instance_type_db")}
        elif cloud_provider == "gce":
            return {"region": self.gce_datacenters[0], "instance_type_db": self.get("gce_instance_type_db")}
        return {}
