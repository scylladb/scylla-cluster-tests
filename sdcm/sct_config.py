...
class SCTConfiguration(dict):
    ...
    config_options = [
        ...
        dict(name="install_mode", env="SCT_INSTALL_MODE", type=str, help="Scylla install mode, repo/offline/web"),
        dict(
            name="scylla_version",
        ...
        dict(name="scylla_mgmt_agent_version", env="SCT_SCYLLA_MGMT_AGENT_VERSION", type=str, help=""),
        dict(
        ...
        dict(
            name="enable_test_profiling", env="SCT_ENABLE_TEST_PROFILING", type=bool, help="""Turn on sct profiling"""
        ),
        dict(
            name="ssh_transport",
            env="SSH_TRANSPORT",
        ...
        dict(name="region_name", env="SCT_REGION_NAME", type=str_or_list_or_eval, help="AWS regions to use"),
        dict(
        ...
        # azure options
        dict(
            name="azure_region_name", env="SCT_AZURE_REGION_NAME", type=str_or_list_or_eval, help="Supported: eastus "
        ),
        ...
        dict(name="test_sst3", env="SCT_TEST_SST3", type=boolean, help=""),
        dict(
            name="test_upgrade_from_installed_3_1_0",
            env="SCT_TEST_UPGRADE_FROM_INSTALLED_3_1_0",
            type=boolean,
            help="Enable an option for installed 3.1.0 for work around a scylla issue if it's true",
        ),
        dict(name="recover_system_tables", env="SCT_RECOVER_SYSTEM_TABLES", type=boolean, help=""),
        dict(
            name="stress_cmd_1",
        ...
        dict(
            ...
            type=str,
            help="How to transport logs: rsyslog, ssh or docker",
            choices=("rsyslog", "ssh", "docker", "syslog-ng"),
        ),
        dict(
            name="rsyslog_imjournal_rate_limit_interval",
            env="SCT_RSYSLOG_IMJOURNAL_RATE_LIMIT_INTERVAL",
            type=int,
            help="Value for rsyslog' imjournal Ratelimit.Interval option (maximum 65535 till rsyslog v8.34)",
        ),
        dict(
            name="rsyslog_imjournal_rate_limit_burst",
            env="SCT_RSYSLOG_IMJOURNAL_RATE_LIMIT_BURST",
            type=int,
        ...
        dict(
            name="use_hdr_cs_histogram",
            env="SCT_USE_HDR_CS_HISTOGRAM",
            type=boolean,
    ...
    def __init__(self):
        ...
        if (oracle_scylla_version := self.get("oracle_scylla_version")) and self.get("db_type") == "mixed_scylla":  # pylint: disable=too-many-nested-blocks
