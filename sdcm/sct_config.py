...
class SCTConfiguration(dict):
    ...
    config_options = [
        ...
        dict(name="vs_docker_image", env="SCT_VS_DOCKER_IMAGE", type=str, help="Vector Store docker image repo"),
        dict(name="vs_version", env="SCT_VS_VERSION", type=str, help="Vector Store version / docker image tag"),
        ...
        dict(
            name="n_vs_nodes", env="SCT_N_VS_NODES", type=int, help="Number of vector store nodes (0 = VS is disabled)"
        ),
        dict(name="vs_port", env="SCT_VS_PORT", type=int, help="Vector Store API port"),
        dict(
            name="vs_scylla_port", env="SCT_VS_SCYLLA_PORT", type=int, help="ScyllaDB connection port for Vector Store"
        ),
        dict(
            name="vs_threads",
            env="SCT_VS_THREADS",
    ...
    def _validate_cloud_backend_parameters(self):
        ...
        supported_versions = [
            v["version"]
            for v in cloud_api_client.get_scylla_versions()["scyllaVersions"]
