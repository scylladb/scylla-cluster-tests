...
class SCTConfiguration(dict):
    ...
    config_options = [
        ...
        dict(name="manager_backup_restore_method", env="SCT_MANAGER_BACKUP_RESTORE_METHOD",
             type=str,
