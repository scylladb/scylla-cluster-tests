...
def run_long_running_cmd(remoter: RemoteCmdRunnerBase, cmd: str, timeout: float | None = None, ignore_status: bool = False, verbose: bool = True, retry: int = 0):
    """
    ...
    with ExitStack() as stack:
        ...
        result = Result(command=cmd, stdout=stdout, stderr=stderr, exited=exit_code, hide=("stderr", "stdout"), pty=False)
