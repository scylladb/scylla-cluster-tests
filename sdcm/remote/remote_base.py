...
class RemoteCmdRunnerBase(CommandRunner):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        self,
        hostname: str,
        user: str = "root",  # pylint: disable=too-many-arguments
        password: str = None,
        port: int = None,
    ...
    def receive_files(
        ...
        src: str,
        dst: str,
        delete_dst: bool = False,  # pylint: disable=too-many-arguments
    ...
    def send_files(
        self,
        src: str,  # pylint: disable=too-many-arguments,too-many-statements
        dst: str,
    ...
    def _run_execute(
        self,
        cmd: str,
        timeout: Optional[float] = None,  # pylint: disable=too-many-arguments
