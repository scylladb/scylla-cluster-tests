...
from sdcm.sct_events.events_processes import EVENTS_FILE_LOGGER_ID, EventsProcessesRegistry, BaseEventsProcess, start_events_process, get_events_process, verbose_suppress
...
def get_events_grouped_by_category(limit: Optional[int] = None, _registry: Optional[EventsProcessesRegistry] = None) -> Dict[str, List[str]]:
