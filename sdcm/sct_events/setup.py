...
def start_events_device(log_dir: str | Path | None = None,
                        _registry: EventsProcessesRegistry | None = None) -> None:
...
def stop_events_device(_registry: EventsProcessesRegistry | None = None) -> None:
