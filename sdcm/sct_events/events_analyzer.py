...
from sdcm.sct_events.events_processes import EVENTS_ANALYZER_ID, EventsProcessesRegistry, BaseEventsProcess, start_events_process, get_events_process, verbose_suppress


LOADERS_EVENTS = {"CassandraStressEvent", "ScyllaBenchEvent", "YcsbStressEvent", "NdbenchStressEvent", "CDCReaderStressEvent"}
