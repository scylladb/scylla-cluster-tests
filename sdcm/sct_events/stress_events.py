...
class StressEvent(BaseStressEvent, abstract=True):
    def __init__(self, node: Any, stress_cmd: Optional[str] = None, log_file_name: Optional[str] = None, errors: Optional[List[str]] = None, severity: Severity = Severity.NORMAL, publish_event: bool = True):
        self.node = str(node)
