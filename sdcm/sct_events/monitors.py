...
class PrometheusAlertManagerEvent(ContinuousEvent):
    ...
    @property
    def msgfmt(self) -> str:
        fmt = super().msgfmt + ": alert_name={0.alert_name} node={0.node} start={0.starts_at} end={0.ends_at} description={0.description} updated={0.updated_at} state={0.state} fingerprint={0.fingerprint} labels={0.labels}"
        return fmt
