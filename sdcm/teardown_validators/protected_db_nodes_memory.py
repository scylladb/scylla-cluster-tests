...
class ProtectedDbNodesMemoryValidator(TeardownValidator):
    ...
    @staticmethod
    def detect_anomalies(prom_values: List[Tuple[int, Union[str, int, float]]], node: BaseNode, metric_name: str):
        """
        ...
        anomalies = detect_isolation_forest_anomalies(prom_values)
