...
class LocalHost(SyslogNGContainerMixin, GcloudContainerMixin, HelmContainerMixin, LdapContainerMixin, JavaContainerMixin, VectorDevContainerMixin, XCloudConnectivityContainerMixin):
    ...
    def ldap_ports(self) -> Optional[dict]:
        return {"ldap_port": ContainerManager.get_container_port(self, "ldap", LDAP_PORT), "ldap_ssl_port": ContainerManager.get_container_port(self, "ldap", LDAP_SSL_PORT)}
