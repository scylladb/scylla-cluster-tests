...
<<<<<<< HEAD
>>>>>>> 905145b03 (docs(sct_config): split the option reference by group, and finish the regrouping)
||||||| parent of 794d9e5e4 (docs(sct_config): drop per-page TOCs, link options in prose, verify mixin validators)
=======
...
>>>>>>> 794d9e5e4 (docs(sct_config): drop per-page TOCs, link options in prose, verify mixin validators)
    """
...
<<<<<<< HEAD
        ...
        dict(
            ...
            type=str,
            help="Version of Scylla Manager server and agent to install",
            appendable=False,
        ),
        dict(
            ...
            type=str,
            help="Version of Scylla Manager server and agent to upgrade to",
            appendable=False,
        ),
        dict(
            ...
            type=str,
            help="Version of ScyllaDB to install as Manager backend",
            appendable=False,
        ),
        dict(
        ...
        dict(
            ...
            type=str_or_list_or_eval,
            help="OCI region where the resources will be deployed",
            appendable=False,
        ),
        dict(
        ...
        dict(
            ...
            type=boolean,
            help="On capacity errors, after all AZs/zones in the configured region are exhausted, relocate to the next "
            "eligible region: a single-region cluster moves as a whole, while in a multi-region test only the exhausted "
            "datacenter is relocated (to a region no other datacenter occupies) and the cluster is retried. On AWS the "
            "target region should be VPC-peered with the runner region with infra-prepared and AMI available; on GCE the "
            "global VPC and global images make any supported region eligible. Only applies during initial setup. "
            "Supported backends: AWS, GCE.",
        ),
        dict(
...
<<<<<<< HEAD
        ...
        dict(
            ...
            type=str,
            help="Type of additional volumes. AWS: gp2|gp3|io2|io3. OCI: lower_cost|balanced|higher_performance|ultra",
        ),
        dict(
        ...
        dict(
            ...
            type=str,
            help="""Scylla Doctor version to use for artifact tests. Set to specific version (e.g., '1.10')
            to hardcode the version, or leave empty to use the latest available version. For stability,
            artifact tests should use a hardcoded version to avoid issues from newer scylla-doctor releases.""",
        ),
        dict(
