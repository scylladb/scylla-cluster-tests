...
class EC2ClientWrapper:
    ...
    def _request_spot_instance(  # pylint: disable=too-many-arguments
        self,
        instance_type,
        image_id,
        region_name,
    ...
    def _request_spot_fleet(  # pylint: disable=too-many-arguments
        self,
        instance_type,
        image_id,
        region_name,
    ...
    def create_spot_instances(  # pylint: disable=too-many-arguments
        self,
        instance_type,
        image_id,
        region_name,
    ...
    def create_spot_fleet(  # pylint: disable=too-many-arguments
        self,
        instance_type,
        image_id,
        region_name,
