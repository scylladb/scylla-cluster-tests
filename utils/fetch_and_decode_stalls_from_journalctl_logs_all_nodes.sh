...
# Usage:    ./fetch_and_decode_stalls_from_one_journalctl_log.sh <logs path> <node IP> <local OS user>
# Example:  ./fetch_and_decode_stalls_from_one_journalctl_log.sh ~/journalctllog/ 5.32.175.60 centos
