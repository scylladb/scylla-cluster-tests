...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--environments", type=str, nargs="+", help=f"ScyllaDB Cloud environments to clean (default: {ENVIRONMENTS})", default=ENVIRONMENTS)
    arg_parser.add_argument("--dry-run", action="store_true", help="Do not delete anything, just print what would be deleted", default=os.environ.get("DRY_RUN"))
