...
def create_oci_json(
    tenancy_id: str, user_id: str, fingerprint: str, private_key_pem: str, region: str, compartment_id: str
) -> dict:
    """Create oci.json credentials dictionary.
    ...
    Returns:
        Dictionary suitable for oci.json
    """
    return {
        "tenancy": tenancy_id,
        "user": user_id,
