...
class PerformanceRegressionAlternatorTest(PerformanceRegressionTest):
    ...
    def _workload(  # pylint: disable=too-many-arguments,arguments-differ
        self,
        stress_cmd,
        stress_num,
        test_name=None,
    ...
    def test_write(self):
        ...
        self._workload(
            sub_type="cql", stress_cmd=base_cmd_w, stress_num=stress_multiplier, keyspace_num=1, is_alternator=False
        )
    ...
    def test_read(self):
        ...
        self._workload(
            sub_type="cql", stress_cmd=base_cmd_r, stress_num=stress_multiplier, keyspace_num=1, is_alternator=False
        )
    ...
    def test_mixed(self):
        ...
        self._workload(
            sub_type="cql", stress_cmd=base_cmd_m, stress_num=stress_multiplier, keyspace_num=1, is_alternator=False
        )
    ...
    def test_latency(self):
        ...
        self._workload(
            ...
            sub_type="cql",
            stress_cmd=base_cmd_w + " -target 10000",
            stress_num=stress_multiplier,
            keyspace_num=1,
            is_alternator=False,
        )
        ...
        self._workload(
            test_name=self.id() + "_write",
            sub_type="with-lwt",
            stress_cmd=base_cmd_w + " -target 3000",
            stress_num=stress_multiplier,
            keyspace_num=1,
        )
        self.check_regression_with_baseline("cql")
        ...
        self._workload(
            ...
            sub_type="cql",
            stress_cmd=base_cmd_m + " -target 10000",
            stress_num=stress_multiplier,
            keyspace_num=1,
            is_alternator=False,
        )
        ...
        self._workload(
            test_name=self.id() + "_mixed",
            sub_type="with-lwt",
            stress_cmd=base_cmd_m + " -target 5000",
            stress_num=stress_multiplier,
            keyspace_num=1,
        )
