...
def call(String backend, String region=null, String datacenter=null, String location=null, String oci_region=null ,Map overrides=null) {
    ...
    def jenkins_labels = ['aws-eu-west-1': 'aws-sct-builders-eu-west-1-v3-asg',
                          ...
                          'gce-us-east4': "${gcp_project}-builders-us-east4-template-v8",
                          'gce-us-west1': "${gcp_project}-builders-us-west1-template-v8",
                          'gce-us-central1': "${gcp_project}-builders-us-central1-template-v8",
                          'gce': "${gcp_project}-builders-us-east1-template-v8",
                          ...
                          'oci': 'oci-sct-builders-us-phoenix-1-v1',
