...
def call(Map pipelineParams) {
    ...
    pipeline {
        ...
        parameters {
            ...
            string(defaultValue: '/scylla-6.1/byo/byo_build_tests_dtest',
                   description: 'Used when byo scylladb repo+branch is provided. Default "/scylla-6.1/byo/byo_build_tests_dtest"',
                   name: 'byo_job_path')
            string(defaultValue: 'scylla',
                   description: '"scylla" or "scylla-enterprise". Default is "scylla".',
                   name: 'byo_default_product')
            string(defaultValue: 'next-6.1',
                   description: 'Default branch to be used for scylla and other repositories. Default is "next-6.1".',
