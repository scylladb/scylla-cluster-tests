...
class CQLTypeBuilder:
    ...
    @classmethod
    def get_random(cls, already_created_info: dict, avoid_types: list = None, allow_levels: int = 1, allowed_types: list = None, forget_on_exhaust=False) -> "CQLColumnType":
        return CQLColumnType.get_random(already_created_info, avoid_types, allow_levels, allowed_types, forget_on_exhaust=forget_on_exhaust)
...
class CQLColumnType:
    ...
    @classmethod
    def get_random(cls, already_created_info: dict, avoid_types: list = None, allow_levels: int = 1, allowed_types: list = None, forget_on_exhaust=False):
        """
        ...
        while True:
            calculated_available_types = cls._get_available_variants(already_created_info, avoid_types, allowed_types, allow_levels)
            while calculated_available_types:
                ...
                if instance._get_random_embedded(self_bucket, avoid_types, allow_levels, allowed_types):
                    return instance
...
class CQLColumnTypeMap(CQLColumnType):
    ...
    def _get_random_embedded(self, already_created_info: dict, avoid_types: list, allow_levels: int, allowed_types: list):
        ...
        self.key_type = self.get_random(already_created_info.get("key_type", {}), tmp, allow_levels - 1, allowed_types)
        self.value_type = self.get_random(already_created_info.get("value_type", {}), tmp, allow_levels - 1, allowed_types)
...
class CQLColumnTypeList(CQLColumnType):
    ...
    def _get_random_embedded(self, already_created_info: dict, avoid_types: list, allow_levels: int, allowed_types: list):
        if avoid_types:
            ...
            tmp = NOT_EMBEDDABLE_COLUMN_TYPES
        self.element_type = self.get_random(already_created_info.get("element_type", {}), tmp, allow_levels - 1, allowed_types)
