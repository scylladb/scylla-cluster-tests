...
def get_data_by_path(data: typing.Union[list, dict, object, typing.Type[object]], data_path: str, default: typing.Any = __DEFAULT__):
    """
...
class MagicList(list):
    def group_by(self, data_path, default: typing.Any = __DEFAULT__, sort_keys=None, group_values: dict = None) -> GroupByType:
        """
