...
""" % (
    ...
    def _workload(  # pylint: disable=too-many-arguments
        self,
        stress_cmd,
        stress_num,
        test_name,
            ...
            # One stress cmd command
                ...
                stress_queue.append(
                    self.run_stress_thread(
                        stress_cmd=prepare_write_cmd, stress_num=1, prefix="preload-", stats_aggregate_cmds=False
                    )
                )
    ...
    def build_histogram(self, workload: PerformanceTestWorkload, test_type: PerformanceTestType):
        ...
        histogram_total_data = self.get_cs_range_histogram(
            stress_operation=workload.value, start_time=start_time, end_time=end_time, tag_type=tag_type
        )
