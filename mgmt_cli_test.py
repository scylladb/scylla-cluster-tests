...
from sdcm.mgmt.common import reconfigure_scylla_manager, get_persistent_snapshots, get_backup_size, ObjectStorageTransferMethod
...
class ManagerRestoreBenchmarkTests(ManagerTestFunctionsMixIn):
    ...
    def test_backup_and_restore_only_data(self, object_storage_method: ObjectStorageTransferMethod):
    ...
    def test_restore_from_precreated_backup(self, snapshot_name: str, object_storage_method: ObjectStorageTransferMethod = None, restore_outside_manager: bool = False):
    ...
    def test_restore_benchmark(self):
        ...
        if object_storage_method := self.params.get('object_storage_method'):
            object_storage_method = ObjectStorageTransferMethod(object_storage_method)
