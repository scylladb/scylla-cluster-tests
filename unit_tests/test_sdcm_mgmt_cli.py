...
def test_01_get_task_info_dict():
    ...
    task = ManagerTask(task_id="13814000-1dd2-11b2-a009-02c33d089f9b", cluster_id="8c20f334-cf37-4528-9219-862d75b84c99", manager_node=manager_node_mock)
    ...
    assert task.get_task_info_dict() == {
        ...
        "Properties": "",
        "mode": "cql",
        "history": [["", "ID", "Start time", "Duration", "Status"], ["", "13814000-1dd2-11b2-a009-02c33d089f9b", "07 Jan 23 23:08:59 UTC", "0s", "DONE"]],
    }
