...
from sdcm.utils.k8s.chaos_mesh import PodFailureExperiment, ExperimentStatus, ChaosMeshTimeout, ChaosMeshExperimentException, MemoryStressExperiment
...
class DummyK8sCluster:
    ...
    def kubectl(self, command, *args, **kwargs):
        ...
        assert result, f"given command: {command} was not registered, failing test. Please register result with 'register_kubectl_result"
        return result[0]
...
def test_podchaos_experiment_configuration_is_valid(capsys):
    ...
    expected_config = {
        ...
        "spec": {"action": "pod-failure", "duration": "10s", "mode": "one", "selector": {"labelSelectors": {"statefulset.kubernetes.io/pod-name": "dummy-pod-1"}}},
    }
...
finished_conditions = '[{"status":"True","type":"AllInjected"},{"status":"True","type":"AllRecovered"},{"status":"False","type":"Paused"},{"status":"True","type":"Selected"}]'
running_conditions = '[{"status":"True","type":"AllInjected"},{"status":"False","type":"AllRecovered"},{"status":"False","type":"Paused"},{"status":"True","type":"Selected"}]'
starting_conditions = '[{"status":"False","type":"AllInjected"},{"status":"False","type":"AllRecovered"},{"status":"False","type":"Paused"},{"status":"False","type":"Selected"}]'
paused_conditions = '[{"status":"True","type":"AllInjected"},{"status":"True","type":"AllRecovered"},{"status":"True","type":"Paused"},{"status":"True","type":"Selected"}]'
error_conditions = '[{"status":"True","type":"AllInjected"},{"status":"False","type":"AllRecovered"},{"status":"True","type":"Paused"},{"status":"False","type":"Selected"}]'
error_conditions_2 = '[{"status":"False","type":"AllInjected"},{"status":"True","type":"AllRecovered"},{"status":"False","type":"Paused"},{"status":"False","type":"Selected"}]'
unknown_conditions = ""
