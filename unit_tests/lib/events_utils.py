...
class EventsUtilsMixin:
    ...
    def setup_events_processes(cls, events_device: bool, events_main_device: bool, registry_patcher: bool):
        ...
        if registry_patcher:
            cls.events_processes_registry_patcher = unittest.mock.patch(
                "sdcm.sct_events.base.SctEvent._events_processes_registry", cls.events_processes_registry
            )
...
||||||| parent of 0c18ab336 (fix(unit_tests): de-flake TestGrafana, the events publisher is the bottleneck)
...
>>>>>>> 0c18ab336 (fix(unit_tests): de-flake TestGrafana, the events publisher is the bottleneck)
