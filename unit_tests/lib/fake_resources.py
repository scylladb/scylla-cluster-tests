...
def prepare_fake_region(test_id: str, region: str, n_db_nodes: int = 3, n_loaders: int = 2, n_monitor_nodes: int = 1):
    ...
    provisioner = provisioner_factory.create_provisioner(backend=region_definition.backend, test_id=region_definition.test_id, region=region_definition.region, availability_zone="a")
