...
@pytest.mark.parametrize("encrypted", [pytest.param(True, marks=pytest.mark.docker_scylla_args(ssl=True), id="encrypted"), pytest.param(False, marks=pytest.mark.docker_scylla_args(ssl=False), id="clear")])
