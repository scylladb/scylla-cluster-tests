...
class ConfigurationTests(unittest.TestCase):  # pylint: disable=too-many-public-methods
    ...
    def test_13_scylla_version_ami_branch(self):  # pylint: disable=invalid-name
        ...
        self.assertEqual(conf.get('ami_id_db_scylla'), 'ami-017455251d171be68 ami-0e3b91517f9ae7efe')
    ...
    def test_21_nested_values(self):
        ...
        self.assertEqual(conf.get('stress_image'),
                         {'alternator-dns': 'scylladb/hydra-loaders:alternator-dns-0.1',
                          ...
                          'gemini': 'scylladb/hydra-loaders:gemini-v1.8.4',
        ...
        self.assertEqual(conf.get('stress_image.gemini'), 'scylladb/hydra-loaders:gemini-v1.8.4')
