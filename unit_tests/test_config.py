...
def test_09_unknown_configure(monkeypatch):
    monkeypatch.setenv("SCT_CLUSTER_BACKEND", "docker")
    monkeypatch.setenv("SCT_CONFIG_FILES", "internal_test_data/unknown_param_in_config.yaml")
    conf = sct_config.SCTConfiguration()
...
def test_10_longevity(monkeypatch):
    monkeypatch.setenv("SCT_CLUSTER_BACKEND", "aws")
    monkeypatch.setenv("SCT_CONFIG_FILES", "internal_test_data/complex_test_case_with_version.yaml")
...
def test_conf_check_required_files_negative(monkeypatch):
    monkeypatch.setenv("SCT_CLUSTER_BACKEND", "aws")
    monkeypatch.setenv("SCT_CONFIG_FILES", "internal_test_data/stress_cmd_with_bad_profile.yaml")
    monkeypatch.setenv(
        "SCT_STRESS_CMD",
...
def test_23_1_include_nemesis_selector(monkeypatch):
    ...
    monkeypatch.setenv(
        "SCT_CONFIG_FILES",
        '["internal_test_data/minimal_test_case.yaml", "internal_test_data/nemesis_selector_list.yaml"]',
    )
...
def test_23_2_nemesis_include_selector_list(monkeypatch):
    ...
    monkeypatch.setenv(
        "SCT_CONFIG_FILES",
        '["internal_test_data/minimal_test_case.yaml", "internal_test_data/nemesis_selector_list_of_list.yaml"]',
    )
...
def test_26_run_fullscan_params_validtion_positive(monkeypatch):
    monkeypatch.setenv(
        "SCT_CONFIG_FILES",
        '["internal_test_data/minimal_test_case.yaml", "internal_test_data/positive_fullscan_param.yaml"]',
    )
    sct_config.SCTConfiguration()
...
def test_27_run_fullscan_params_validtion_negative(monkeypatch):
    monkeypatch.setenv(
        "SCT_CONFIG_FILES",
        '["internal_test_data/minimal_test_case.yaml", "internal_test_data/negative_fullscan_param.yaml"]',
    )
    try:
        sct_config.SCTConfiguration()
