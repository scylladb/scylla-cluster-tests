...
def test_scylla_repo(scylla_version, expected_outcome, distro, monkeypatch):
    ...
    monkeypatch.setenv("SCT_SCYLLA_VERSION", scylla_version)
    monkeypatch.setenv("SCT_GCE_IMAGE_DB", "https://www.googleapis.com/compute/v1/projects/centos-cloud/global/images/family/centos-7")
...
def test_unified_package(monkeypatch):
    monkeypatch.setenv("SCT_CLUSTER_BACKEND", "gce")
    monkeypatch.setenv("SCT_UNIFIED_PACKAGE", ("https://downloads.scylladb.com/unstable/scylla/master/relocatable/2023-11-13T03:04:27Z/scylla-unified-5.5.0~dev-0.20231113.7b08886e8dd8.x86_64.tar.gz"))
    monkeypatch.setenv("SCT_GCE_IMAGE_DB", "https://www.googleapis.com/compute/v1/projects/centos-cloud/global/images/family/centos-7")
