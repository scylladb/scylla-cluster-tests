...
<<<<<<< HEAD:unit_tests/test_config_get_version_based_on_conf.py
||||||| parent of bd2dbde48 (refactor(sct_config): repoint patch targets and docs at the package):unit_tests/integration/test_config_get_version_based_on_conf.py
...
>>>>>>> bd2dbde48 (refactor(sct_config): repoint patch targets and docs at the package):unit_tests/integration/test_config_get_version_based_on_conf.py
