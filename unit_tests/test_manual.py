...
class Node(object):  # pylint: disable=no-init,too-few-public-methods
...
class DbNode(object):  # pylint: disable=no-init,too-few-public-methods
    ip_address = "34.244.157.61"
    dc_idx = 1


class LoaderSetDummy(object):  # pylint: disable=no-init,too-few-public-methods
    @staticmethod
    def get_db_auth():
        return None
