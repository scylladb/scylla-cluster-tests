...
class LongevityPipelineTest:
    ...
    def pattern_rsync_sct_dir(self):
        return f"rsync -ar -e 'ssh -o StrictHostKeyChecking=no' --delete {self.sct_base_path} ubuntu@1.1.1.1:/home/ubuntu/"
    ...
    def create_runner_cmd(self):
        return f"create-runner-instance --cloud-provider {self.backend} --region eu-north-1 --availability-zone a --test-id {self.test_id} --duration 465"
    ...
    def get_longevity_env(self) -> Dict[str, str]:
        longevity_end = {
            ...
            "SCT_CONFIG_FILES": '["/jenkins/slave/workspace/siren-tests/longevity-tests/cloud-longevity-small-data-set-1h-gcp/siren-tests/sct_plugin/configurations/scylla_cloud_nemesis_small_set.yaml"]',
        }
    ...
    def test_tmp_dir(self) -> HydraTestCaseTmpDir:
        return HydraTestCaseTmpDir(home_dir=self.test_home_dir, aws_creds=self.aws_creds)
    ...
    def test_case_show_conf(self):
        ...
        return HydraTestCaseParams(
            ...
            expected=[*self.before_runner_expected, re.compile(f"{self.before_runner_docker_run_prefix} eval './sct.py  {self.show_conf_cmd}'")],
    ...
    def test_case_create_runner(self):
        ...
        return HydraTestCaseParams(
            ...
            expected=[*self.before_runner_expected, re.compile(f"{self.before_runner_docker_run_prefix} eval './sct.py  {self.create_runner_cmd}'")],
            not_expected=[*self.before_runner_not_expected],
            return_code=0,
            env=self.get_longevity_env,
        ), self.test_tmp_dir
    ...
    def test_case_run_test(self):
        ...
        return HydraTestCaseParams(
            ...
            expected=[*self.after_runner_expected, re.compile(f"{self.after_runner_docker_run_prefix} eval './sct.py  {self.run_test_cmd_docker}'")],
    ...
    def test_case_collect_logs(self):
        ...
        return HydraTestCaseParams(
            ...
            expected=[*self.after_runner_expected, re.compile(f"{self.after_runner_docker_run_prefix} eval './sct.py  {self.collect_logs_cmd_docker}'")],
            not_expected=[*self.after_runner_not_expected],
            return_code=0,
            env=self.get_longevity_env,
        ), self.test_tmp_dir
    ...
    def test_case_clean_resources(self):
        ...
        return HydraTestCaseParams(
            ...
            expected=[*self.after_runner_expected, re.compile(f"{self.after_runner_docker_run_prefix} eval './sct.py  {self.clean_resources_cmd_docker}'")],
            not_expected=[*self.after_runner_not_expected],
            return_code=0,
            env=self.get_longevity_env,
        ), self.test_tmp_dir
    ...
    def test_case_clean_runner_instances(self):
        ...
        return HydraTestCaseParams(
            ...
            expected=[*self.after_runner_expected, re.compile(f"{self.after_runner_docker_run_prefix} eval './sct.py  {self.clean_runner_instances_cmd_docker}'")],
            not_expected=[*self.after_runner_not_expected],
            return_code=0,
            env=self.get_longevity_env,
        ), self.test_tmp_dir
    ...
    def test_case_send_email(self):
        ...
        return HydraTestCaseParams(
            ...
            expected=[*self.after_runner_expected, re.compile(f"{self.after_runner_docker_run_prefix} eval './sct.py  {self.send_email_cmd_docker}'")],
            not_expected=[*self.after_runner_not_expected],
            return_code=0,
            env=self.get_longevity_env,
        ), self.test_tmp_dir
    ...
    def hydra_test_cases(self) -> Iterable[Tuple[HydraTestCaseParams, HydraTestCaseTmpDir]]:
        ...
        """
        return (self.test_case_show_conf, self.test_case_create_runner, self.test_case_run_test, self.test_case_collect_logs, self.test_case_clean_resources, self.test_case_clean_runner_instances)
...
class TestHydraSh(unittest.TestCase):
    ...
    def test_run_test(self, test_case_params: HydraTestCaseParams, tmp_dir: HydraTestCaseTmpDir):
        with tmp_dir:
            ...
            result = self.cmd_runner.run(sct_abs_path("docker/env/hydra.sh") + " --dry-run-hydra " + cmd, ignore_status=True)
