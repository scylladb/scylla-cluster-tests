...
class TestHealthCheckPerformance:
    """
    Performance measurement tests for health check optimizations.
    ...
    @pytest.fixture
    def mock_nodes_with_delay(self):
        """
    ...
    def measure_execution_time(self, nodes, parallel_workers):
        """
    ...
    def test_baseline_sequential_execution(self, mock_nodes_with_delay):
        """
        ...
        execution_time = self.measure_execution_time(nodes, parallel_workers=1)
    ...
    def test_parallel_execution_5_workers(self, mock_nodes_with_delay):
        """
        ...
        sequential_time = self.measure_execution_time(nodes, parallel_workers=1)
        ...
        parallel_time = self.measure_execution_time(nodes, parallel_workers=5)
    ...
    def test_parallel_execution_10_workers(self, mock_nodes_with_delay):
        """
        ...
        parallel_time = self.measure_execution_time(nodes, parallel_workers=10)
    ...
    def test_performance_scaling_multiple_runs(self, mock_nodes_with_delay):
        """
        ...
        for run_num in range(num_runs):
            ...
            execution_time = self.measure_execution_time(nodes, parallel_workers)
    ...
    def test_diminishing_returns_beyond_10_workers(self):
        """
        ...
        for worker_count in [1, 5, 10, 15, 20]:
            ...
            times[worker_count] = self.measure_execution_time(nodes, worker_count)
    ...
    def test_small_cluster_performance(self):
        """
