...
class TestParallelHealthCheckExecution:
    """Test suite for parallel health check execution."""
    ...
    def test_parallel_workers_config_default(self, mock_cluster):
    ...
    def test_parallel_workers_config_custom(self, mock_cluster):
    ...
    def test_parallel_workers_bounds_checking(self):
    ...
    def test_sequential_execution_single_worker(self, mock_cluster, mock_nodes):
    ...
    def test_single_node_uses_sequential_execution(self, mock_cluster, mock_nodes):
