...
class ScyllaYamlTest(unittest.TestCase):
    ...
    def test_server_encryption_options(self):
        self._run_test(
            ...
            expected_with_defaults={"internode_encryption": "none", "certificate": "/tmp/123.crt", "keyfile": "/tmp/123.key", "truststore": None, "priority_string": None, "require_client_auth": False},
        )
    ...
    def test_client_encryption_options(self):
        self._run_test(
            ...
            expected_without_defaults={"certificate": "/tmp/123.crt", "keyfile": "/tmp/123.key", "truststore": "/tmp/123.pem", "require_client_auth": True},
            expected_with_defaults={"enabled": False, "certificate": "/tmp/123.crt", "keyfile": "/tmp/123.key", "truststore": "/tmp/123.pem", "priority_string": None, "require_client_auth": True},
        )
    ...
    def test_seed_provider(self):
        self._run_test(
            ...
            init_params={"class_name": "org.apache.cassandra.locator.SimpleSeedProvider", "parameters": [{"seeds": ["1.1.1.1", "2.2.2.2"]}]},
            expected_without_defaults={"class_name": "org.apache.cassandra.locator.SimpleSeedProvider", "parameters": [{"seeds": ["1.1.1.1", "2.2.2.2"]}]},
            expected_with_defaults={"class_name": "org.apache.cassandra.locator.SimpleSeedProvider", "parameters": [{"seeds": ["1.1.1.1", "2.2.2.2"]}]},
        )
    ...
    def test_scylla_yaml(self):
        self._run_test(
            ...
            init_params={
                ...
                "seed_provider": [
                    SeedProvider(class_name="org.apache.cassandra.locator.SimpleSeedProvider", parameters=[{"seeds": ["1.1.1.1", "2.2.2.2"]}]),
                ],
            ...
            expected_without_defaults={
                ...
                "auto_adjust_flush_quota": False,
                "listen_address": "localhost",
                "seed_provider": [{"class_name": "org.apache.cassandra.locator.SimpleSeedProvider", "parameters": [{"seeds": ["1.1.1.1", "2.2.2.2"]}]}],
                "server_encryption_options": {"internode_encryption": "none", "certificate": "/tmp/123.crt", "keyfile": "/tmp/123.key"},
                "client_encryption_options": {"enabled": False, "certificate": "/tmp/123.crt", "keyfile": "/tmp/123.key", "require_client_auth": True},
                "prometheus_prefix": "someprefix",
                "log_to_stdout": True,
                "force_schema_commit_log": True,
            },
            expected_with_defaults={
                ...
                "client_encryption_options": {"certificate": "/tmp/123.crt", "enabled": False, "keyfile": "/tmp/123.key", "priority_string": None, "require_client_auth": True, "truststore": None},
                "cluster_name": None,
                ...
                "seed_provider": [{"class_name": "org.apache.cassandra.locator.SimpleSeedProvider", "parameters": [{"seeds": ["1.1.1.1", "2.2.2.2"]}]}],
                "server_encryption_options": {"certificate": "/tmp/123.crt", "internode_encryption": "none", "keyfile": "/tmp/123.key", "priority_string": None, "require_client_auth": False, "truststore": None},
    ...
    def test_update_with_scylla_yaml_object():
        ...
        assert yaml1 == ScyllaYaml(
            ...
            redis_keyspace_replication_strategy="SimpleStrategy",
            server_encryption_options=ServerEncryptionOptions(internode_encryption="all", certificate="/tmp/123.crt", keyfile="/tmp/123.key", truststore="/tmp/trust.pem"),
            client_encryption_options=ClientEncryptionOptions(),
        )
    ...
    def test_copy():
        ...
        assert copy_instance.model_dump(exclude_unset=True, exclude_defaults=True) == original.model_dump(exclude_unset=True, exclude_defaults=True)
