...
class TestArgusDisabled(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Set up Argus client to return a MagicMock (simulating disabled state)
        # This matches the default state in TestConfig when enable_argus: false
        self.disabled_argus_client = MagicMock()
        self.mock_test_config_instance.argus_client.return_value = self.disabled_argus_client
    ...
    def test_add_node_to_argus_when_disabled(self):
        ...
        # Verify that no API methods were called on the disabled client
        # because isinstance(self.disabled_argus_client, MagicMock) is True
        self.disabled_argus_client.create_resource.assert_not_called()
    ...
    def test_update_rack_info_in_argus_when_disabled(self):
        ...
        # Verify that no API methods were called
        self.disabled_argus_client.update_resource.assert_not_called()
    ...
    def test_terminate_node_in_argus_when_disabled(self):
        ...
        # Verify that no API methods were called
        self.disabled_argus_client.terminate_resource.assert_not_called()
