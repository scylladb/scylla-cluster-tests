...
class TestValidators(unittest.TestCase):
    def test_cluster_health_validator_event(self):
        ...
        self.assertTrue(issubclass(ClusterHealthValidatorEvent.ScyllaCloudClusterServerDiagnostic, ClusterHealthValidatorEvent))
    ...
    def test_cluster_health_validator_event_msgfmt(self):
        ...
        self.assertEqual(str(chc_event), "(ClusterHealthValidatorEvent Severity.NORMAL) period_type=begin event_id=7208cfbb-a083-4b7a-b0db-1982d88f6da0")
        ...
        self.assertEqual(str(critical_event), "(ClusterHealthValidatorEvent Severity.CRITICAL) period_type=one-time event_id=712128d0-4837-4213-8a60-d6e2ec106c52: type=NodeStatus node=n1 error=e1")
        ...
        self.assertEqual(str(error_event), "(ClusterHealthValidatorEvent Severity.ERROR) period_type=one-time event_id=712128d0-4837-4213-8a60-d6e2ec106c52: type=NodePeersNulls node=n2 error=e2")
        ...
        self.assertEqual(str(warning_event), "(ClusterHealthValidatorEvent Severity.WARNING) period_type=one-time event_id=712128d0-4837-4213-8a60-d6e2ec106c52: type=NodeSchemaVersion node=n3 message=m3")
        ...
        self.assertEqual(str(info_event), "(ClusterHealthValidatorEvent Severity.WARNING) period_type=one-time event_id=712128d0-4837-4213-8a60-d6e2ec106c52: type=NodesNemesis node=n4 message=m4")
        ...
        chc_event.end_event()
        self.assertEqual(str(chc_event), "(ClusterHealthValidatorEvent Severity.NORMAL) period_type=end event_id=7208cfbb-a083-4b7a-b0db-1982d88f6da0 duration=5s message=Cluster health check finished")
    ...
    def test_data_validator_event_msgfmt(self):
        ...
        self.assertEqual(str(critical_event), "(DataValidatorEvent Severity.ERROR) period_type=one-time event_id=3916da00-643c-4886-bdd0-963d3ebac536: type=DataValidator error=e1")
        self.assertEqual(critical_event, pickle.loads(pickle.dumps(critical_event)))
        ...
        self.assertEqual(str(error_event), "(DataValidatorEvent Severity.ERROR) period_type=one-time event_id=3916da00-643c-4886-bdd0-963d3ebac536: type=ImmutableRowsValidator error=e2")
        self.assertEqual(error_event, pickle.loads(pickle.dumps(error_event)))
        ...
        self.assertEqual(str(warning_event), "(DataValidatorEvent Severity.WARNING) period_type=one-time event_id=3916da00-643c-4886-bdd0-963d3ebac536: type=UpdatedRowsValidator message=m3")
        self.assertEqual(warning_event, pickle.loads(pickle.dumps(warning_event)))
        ...
        self.assertEqual(str(info_event), "(DataValidatorEvent Severity.NORMAL) period_type=one-time event_id=3916da00-643c-4886-bdd0-963d3ebac536: type=DeletedRowsValidator message=m4")
        self.assertEqual(info_event, pickle.loads(pickle.dumps(info_event)))
