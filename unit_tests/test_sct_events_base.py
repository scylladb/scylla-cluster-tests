...
class TestSctEvent(SctEventTestCase):
    ...
    def test_default_str(self):
        ...
        self.assertEqual(str(y), "(Y Severity.UNKNOWN) period_type=not-set event_id=d81c016f-2333-4047-8c91-7cde98c38a15")
...
class TestLogEvent(SctEventTestCase):
    ...
    def test_msgfmt(self):
        ...
        self.assertEqual(str(y), "(Y Severity.ERROR) period_type=one-time event_id=04ace3fb-b9bc-4c86-bfb2-2ffae18bb72e: type=T regex=r1 line_number=0")

        y.add_info(node="n1", line="l1", line_number=1)
        self.assertEqual(str(y), "(Y Severity.ERROR) period_type=one-time event_id=04ace3fb-b9bc-4c86-bfb2-2ffae18bb72e: type=T regex=r1 line_number=1 node=n1\nl1")
