...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"target_branch": "2025.2", "target_rc_only": False, "base_version_all_sts_versions": False, "supported_versions": ["2024.1", "2024.2", "2025.1", "2025.2", "2025.3", "2025.4"], "expected_version_set": {"2025.1", "2025.2"}},
        {
        ...
        {"target_branch": "2025.4", "target_rc_only": True, "base_version_all_sts_versions": True, "supported_versions": ["2024.1", "2024.2", "2025.1", "2025.2", "2025.3", "2025.4"], "expected_version_set": {"2025.1", "2025.2", "2025.3"}},
        {
...
def test_upgrade_matrix_stages(test_case):
    ...
    scylla_repo = url_base + f"/branch-{target_branch}/deb/unified/2026-02-16T22:46:42Z/scylladb-{target_branch}/scylla.list"
    linux_distro = "ubuntu-focal"
    ...
    with patch("utils.get_supported_scylla_base_versions.get_all_versions", return_value=mock_versions), patch("utils.get_supported_scylla_base_versions.get_s3_scylla_repos_mapping", return_value=mock_repo_map):
        version_list = general_test(scylla_repo, linux_distro, base_version_all_sts_versions=base_version_all_sts_versions)
...
def test_master_all_sts_versions():
    ...
    with (
        patch("utils.get_supported_scylla_base_versions.get_all_versions", return_value=["2024.1", "2024.2", "2025.1", "2025.2", "2025.3", "2025.4", "2026.1"]),
