...
def test_user_data_builder_generates_valid_yaml_from_single_user_data_object():
    ...
    assert (
        ...
        == "cd /var/lib/sct/cloud-init; bash -eux /var/lib/sct/cloud-init/0_ExampleUserDataObject.sh; test  $? = 0 || touch /var/lib/sct/cloud-init/0_ExampleUserDataObject.sh.failed"
    )
