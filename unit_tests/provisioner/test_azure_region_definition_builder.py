...
def test_can_create_basic_scylla_instance_definition_from_sct_config(monkeypatch):
    ...
    EnvConfig = namedtuple("EnvConfig", ["SCT_CLUSTER_BACKEND", "SCT_TEST_ID", "SCT_CONFIG_FILES", "SCT_AZURE_REGION_NAME", "SCT_N_DB_NODES", "SCT_USER_PREFIX", "SCT_AZURE_IMAGE_DB", "SCT_N_LOADERS", "SCT_N_MONITORS_NODES"])
    ...
    instance_definition = InstanceDefinition(
        ...
        user_name="scyllaadm",
        root_disk_size=30,
        tags=tags | {"NodeType": "scylla-db", "keep_action": "terminate", "NodeIndex": "1", "TestId": test_config.test_id()},
        ssh_key=ssh_key,
    )
