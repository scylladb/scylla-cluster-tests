...
def dict_keys_to_camel_case(dct):
    ...
    return {snake_case_to_camel_case(a): dict_keys_to_camel_case(b) if isinstance(b, (dict, list)) else b for a, b in dct.items()}
...
class ResultableObject:
    ...
    def result(
        ...
        value = InstanceViewStatus(
            additional_properties={}, code="ProvisioningState/succeeded", level="Info", display_status="Provisioning succeeded", message=f"Enable succeeded: \n[stdout]\n{self.stdout}\n[stderr]\n{self.stderr}", time=None
        )
...
class FakeNetworkSecurityGroup:
    ...
    def begin_create_or_update(self, resource_group_name: str, network_security_group_name: str, parameters: Dict[str, Any]) -> WaitableObject:
        base = {
            "id": f"/subscriptions/6c268694-47ab-43ab-b306-3c5514bc4112/resourceGroups/{resource_group_name}/providers/Microsoft.Network/networkSecurityGroups/default",
            "name": network_security_group_name,
            "type": "Microsoft.Network/networkSecurityGroups",
            "location": parameters["location"],
            "etag": 'W/"90369d69-7507-4e77-8b90-66e1f971f290"',
            "properties": {"subnets": [], "resourceGuid": "2100b376-ad42-449d-a9c2-62cdade9db83", "provisioningState": "Succeeded"},
        }
        rules = []
        for rule in parameters["security_rules"]:
            rules.append(
                {
                    "id": f"/subscriptions/6c268694-47ab-43ab-b306-3c5514bc4112/resourceGroups/{resource_group_name}/providers/Microsoft.Network/networkSecurityGroups/default/securityRules/{rule['name']}",
                    "name": rule["name"],
                    "etag": 'W/"90369d69-7507-4e77-8b90-66e1f971f290"',
        ...
        with open(self.path / resource_group_name / f"nsg-{network_security_group_name}.json", "w", encoding="utf-8") as file:
            json.dump(base, fp=file, indent=2)
        return WaitableObject()

    def get(self, resource_group_name: str, network_security_group_name: str) -> NetworkSecurityGroup:
        try:
            with open(self.path / resource_group_name / f"nsg-{network_security_group_name}.json", "r", encoding="utf-8") as file:
...
class FakeVirtualNetwork:
    ...
    def begin_create_or_update(self, resource_group_name: str, virtual_network_name: str, parameters: Dict[str, Any]) -> WaitableObject:
        base = {
            "id": f"/subscriptions/6c268694-47ab-43ab-b306-3c5514bc4112/resourceGroups/{resource_group_name}/providers/Microsoft.Network/virtualNetworks/{virtual_network_name}",
...
class FakeSubnet:
    ...
    def list(self, resource_group_name: str, virtual_network_name: str) -> List[Subnet]:
        try:
            files = [file for file in os.listdir(self.path / resource_group_name) if file.startswith(f"subnet-{virtual_network_name}")]
        except FileNotFoundError:
            raise ResourceNotFoundError("No resource group") from None
        elements = []
        for file_name in files:
    ...
    def begin_create_or_update(self, resource_group_name: str, virtual_network_name: str, subnet_name: str, subnet_parameters: Dict[str, Any]) -> WaitableObject:
        base = {
            "id": f"/subscriptions/6c268694-47ab-43ab-b306-3c5514bc4112/resourceGroups/{resource_group_name}/providers/Microsoft.Network/virtualNetworks/{virtual_network_name}/subnets/{subnet_name}",
            "name": subnet_name,
            "etag": 'W/"821c1ea3-6313-4798-859b-63ba15e882cc"',
        ...
        with open(self.path / resource_group_name / f"subnet-{virtual_network_name}-{subnet_name}.json", "w", encoding="utf-8") as file:
            json.dump(base, fp=file, indent=2)
        return WaitableObject()

    def get(self, resource_group_name: str, virtual_network_name: str, subnet_name: str) -> NetworkSecurityGroup:
        try:
            with open(self.path / resource_group_name / f"subnet-{virtual_network_name}-{subnet_name}.json", "r", encoding="utf-8") as file:
...
class FakeIpAddress:
    ...
    def begin_create_or_update(self, resource_group_name: str, public_ip_address_name: str, parameters: Dict[str, Any]) -> WaitableObject:
        base = {
            "id": f"/subscriptions/6c268694-47ab-43ab-b306-3c5514bc4112/resourceGroups/{resource_group_name}/providers/Microsoft.Network/publicIPAddresses/{public_ip_address_name}",
    ...
    def get(self, resource_group_name: str, public_ip_address_name: str) -> PublicIPAddress:
        try:
            with open(self.path / resource_group_name / f"ip-{public_ip_address_name}.json", "r", encoding="utf-8") as file:
...
class FakeNetworkInterface:
    ...
    def begin_create_or_update(self, resource_group_name: str, network_interface_name: str, parameters: Dict[str, Any]) -> WaitableObject:
        base = {
            "id": f"/subscriptions/6c268694-47ab-43ab-b306-3c5514bc4112/resourceGroups/{resource_group_name}/providers/Microsoft.Network/networkInterfaces/{network_interface_name}",
            ...
            "properties": {
                "ipConfigurations": [
                    {
                        ...
                        "properties": {
                            ...
                            "publicIPAddress": {
                                ...
                                "name": parameters["ip_configurations"][0]["public_ip_address"]["id"].split("/", -1)[-1],
                                "type": "Microsoft.Network/publicIPAddresses",
                ...
                "tapConfigurations": [],
                "dnsSettings": {"dnsServers": [], "appliedDnsServers": [], "internalDomainNameSuffix": "guhwn0jlt20edcyogcn3tm1zfe.bx.internal.cloudapp.net"},
    ...
    def get(self, resource_group_name: str, network_interface_name: str) -> NetworkInterface:
        try:
            with open(self.path / resource_group_name / f"nic-{network_interface_name}.json", "r", encoding="utf-8") as file:
...
class FakeVirtualMachines:
    ...
    def begin_create_or_update(self, resource_group_name: str, vm_name: str, parameters: Dict[str, Any]) -> WaitableObject:
        ...
        base = {
            "id": f"/subscriptions/6c268694-47ab-43ab-b306-3c5514bc4112/resourceGroups/{resource_group_name}/providers/Microsoft.Compute/virtualMachines/{vm_name}",
            "name": vm_name,
            ...
            "properties": {
                ...
                "storageProfile": {
                    "imageReference": {"publisher": "OpenLogic", "offer": "CentOS", "sku": "7.5", "version": "latest", "exactVersion": "7.5.201808150"},
                    "osDisk": {
                        "osType": "Linux",
                        ...
                        "diskSizeGB": 30,
                        "managedDisk": {
                            "id": f"/subscriptions/6c268694-47ab-43ab-b306-3c5514bc4112/resourceGroups/{resource_group_name}/providers/Microsoft.Compute/disks/{vm_name}_OsDisk_1_7fcdd979aec64c40b5b153bfe9daed35",
                ...
                "osProfile": {
                    ...
                    "linuxConfiguration": {
                        ...
                        "ssh": {"publicKeys": [{"path": "/home/lukasz/.ssh/authorized_keys", "keyData": "ssh-rsa fake_key_data== scylla_test_id_ed25519\n"}]},
                ...
                "networkProfile": {
                    "networkInterfaces": [
                        {"id": f"/subscriptions/6c268694-47ab-43ab-b306-3c5514bc4112/resourceGroups/{resource_group_name}/providers/Microsoft.Network/networkInterfaces/lukasz-3-nic", "properties": {"deleteOption": "Delete"}}
                    ]
                },
                "provisioningState": "Succeeded",
    ...
    def begin_delete(self, resource_group_name: str, vm_name: str) -> WaitableObject:
        ...
        network_svc.public_ip_addresses.begin_delete(resource_group_name, nic.ip_configurations[0].public_ip_address.name)
        return WaitableObject()
