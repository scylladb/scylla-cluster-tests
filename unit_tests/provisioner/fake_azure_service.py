...
class FakeVirtualMachines:
    ...
    def get(self, resource_group_name: str, vm_name: str, expand: str = "") -> VirtualMachine:  # pylint: disable=unused-argument
        try:
            with open(self.path / resource_group_name / f"vm-{vm_name}.json", "r", encoding="utf-8") as file:
    ...
    def begin_restart(  # pylint: disable=unused-argument, no-self-use
        self,
        resource_group_name,
        vm_name,
    ) -> WaitableObject:
