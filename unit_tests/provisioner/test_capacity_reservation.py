...
def test_reserve_success(mock_ec2, params):
    mock_ec2.create_capacity_reservation.side_effect = [{"CapacityReservation": {"CapacityReservationId": "cr-0e2dec33c962ffa7d"}}, {"CapacityReservation": {"CapacityReservationId": "cr-0e2dec33c962ffa7e"}}]
...
def test_can_cancel_reservation(mock_ec2, params):
    mock_ec2.describe_capacity_reservations.return_value = {"CapacityReservations": [{"AvailabilityZone": "us-east-1b", "CapacityReservationId": "cr-0e2dec33c962ffa7d", "InstanceType": "i4i.large", "State": "active"}]}
