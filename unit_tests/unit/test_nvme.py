...
def test_poll_self_test_completion_immediate(monkeypatch):
    ...
    monkeypatch.setattr("sdcm.utils.nvme.get_self_test_log", lambda n, d: completed_log)
...
def test_poll_self_test_completion_waits_then_completes(monkeypatch):
    ...
    monkeypatch.setattr("sdcm.utils.nvme.get_self_test_log", mock_get_self_test_log)
...
def test_poll_self_test_completion_timeout_aborts(monkeypatch):
    ...
    monkeypatch.setattr("sdcm.utils.nvme.get_self_test_log", lambda n, d: in_progress_log)
    # Mock abort_self_test to track it was called
    abort_called = []
    monkeypatch.setattr("sdcm.utils.nvme.abort_self_test", lambda n, d: abort_called.append(d) or True)
...
def test_run_self_test_on_all_devices_no_nvme_cli(monkeypatch):
    ...
    node = _make_mock_node()
    monkeypatch.setattr("sdcm.utils.nvme.is_nvme_cli_available", lambda n: False)
...
def test_run_self_test_on_all_devices_no_devices(monkeypatch):
    ...
    node = _make_mock_node()
    monkeypatch.setattr("sdcm.utils.nvme.is_nvme_cli_available", lambda n: True)
    monkeypatch.setattr("sdcm.utils.nvme.list_nvme_devices", lambda n: [])
