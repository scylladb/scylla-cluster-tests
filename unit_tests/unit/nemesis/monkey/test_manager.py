...
def test_get_manager_tool_delegates_to_mgmt(mock_mgmt):
    """Verify get_manager_tool calls mgmt.get_scylla_manager_tool with the first monitor node."""
    tester = MagicMock()
...
def test_delete_existing_backups_removes_actionable_tasks(runner):
    """Verify delete_existing_backups deletes tasks with NEW/RUNNING/STARTING/ERROR status."""
...
def test_delete_existing_backups_no_tasks(runner):
    """Verify delete_existing_backups does nothing when task list is empty."""
    mgr_cluster = MagicMock()
...
# ---------------------------------------------------------------------------
# mgmt_backup — UnsupportedNemesis guards
# ---------------------------------------------------------------------------


def test_mgmt_backup_raises_when_no_manager_configured(runner):
    """Verify mgmt_backup raises UnsupportedNemesis when neither use_mgmt nor use_cloud_manager is set."""
...
def test_mgmt_backup_raises_when_no_bucket_location(runner):
    """Verify mgmt_backup raises UnsupportedNemesis when backup_bucket_location is not configured."""
