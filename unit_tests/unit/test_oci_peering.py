...
@patch(
    "sdcm.utils.oci_region.OciRegion.drg_attachment",
...
@patch("sdcm.utils.oci_utils.OciService.get_identity_client", return_value=MagicMock())
@patch("sdcm.utils.oci_utils.OciService.get_compute_client", return_value=MagicMock())
def test_configure_route_tables_delegates_to_region(mock_compute, mock_identity, mock_network):
...
@patch("sdcm.utils.oci_utils.OciService.get_identity_client", return_value=MagicMock())
@patch("sdcm.utils.oci_utils.OciService.get_compute_client", return_value=MagicMock())
def test_open_security_list_delegates_to_region(mock_compute, mock_identity, mock_network):
...
@patch("sdcm.utils.oci_utils.OciService.get_identity_client", return_value=MagicMock())
@patch("sdcm.utils.oci_utils.OciService.get_compute_client", return_value=MagicMock())
def test_drg_create_when_none_exists(
    mock_compute,
    mock_identity,
    mock_network,
    mock_comp,
...
@patch("sdcm.utils.oci_utils.OciService.get_identity_client", return_value=MagicMock())
@patch("sdcm.utils.oci_utils.OciService.get_compute_client", return_value=MagicMock())
def test_drg_find_existing(mock_compute, mock_identity, mock_network, mock_comp, mock_paginator, mock_user):
...
@patch("sdcm.utils.oci_utils.OciService.get_identity_client", return_value=MagicMock())
@patch("sdcm.utils.oci_utils.OciService.get_compute_client", return_value=MagicMock())
def test_rpc_create_when_none_exists(
    mock_compute,
    mock_identity,
    mock_network,
    mock_drg,
...
@patch("sdcm.utils.oci_utils.OciService.get_identity_client", return_value=MagicMock())
@patch("sdcm.utils.oci_utils.OciService.get_compute_client", return_value=MagicMock())
def test_add_drg_route_to_tables_skips_if_exists(
    mock_compute,
    mock_identity,
    mock_network,
    mock_drg,
...
@patch("sdcm.utils.oci_utils.OciService.get_identity_client", return_value=MagicMock())
@patch("sdcm.utils.oci_utils.OciService.get_compute_client", return_value=MagicMock())
def test_add_drg_route_to_tables_adds_new_rule(
    mock_compute,
    mock_identity,
    mock_network,
    mock_drg,
...
@patch("sdcm.utils.oci_utils.OciService.get_identity_client", return_value=MagicMock())
@patch("sdcm.utils.oci_utils.OciService.get_compute_client", return_value=MagicMock())
def test_allow_cross_vcn_traffic_skips_if_exists(mock_compute, mock_identity, mock_network, mock_sl):
...
@patch("sdcm.utils.oci_utils.OciService.get_identity_client", return_value=MagicMock())
@patch("sdcm.utils.oci_utils.OciService.get_compute_client", return_value=MagicMock())
def test_allow_cross_vcn_traffic_adds_rule(mock_compute, mock_identity, mock_network, mock_sl):
