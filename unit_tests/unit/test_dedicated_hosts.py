            ...
            "Hosts": [
                {
                    ...
                    "AvailableCapacity": {
                        "AvailableInstanceCapacity": [
                            {"AvailableCapacity": 64, "InstanceType": "i4i.large", "TotalCapacity": 64}
                        ],
                        "AvailableVCpus": 128,
                    },
                    "HostId": "h-0af5175ea085157f0",
                    "HostProperties": {"Cores": 64, "InstanceType": "i4i.large", "Sockets": 2, "TotalVCpus": 128},
                    "Instances": [],
                    "State": "available",
                    "Tags": [
                        {"Key": "TestId", "Value": "None"},
                        {"Key": "TestName", "Value": "None"},
                        {"Key": "CreatedBy", "Value": "SCT"},
                        {"Key": "version", "Value": "unknown"},
                        {"Key": "RunByUser", "Value": "fruch"},
                        {"Key": "test_id", "Value": "1234-1234-1234"},
                    ],
                    "HostRecovery": "off",
                    "AllowsMultipleInstanceTypes": "off",
                    "OwnerId": "797456418907",
...
def test_release_retries(mock_ec2, params):
    ...
    mock_ec2.release_hosts.side_effect = [
        {"Unsuccessful": [{"Error": {"Code": "000", "Message": "error"}}]},
        {"Successful": ["h-0867aada366f84ff1"]},
    ]
...
def test_release_by_tag_unit_unit(mock_ec2):
    ...
    mock_ec2.describe_hosts.side_effect = [{"Hosts": [{"HostId": "h-0af5175ea085157f0"}]}]
