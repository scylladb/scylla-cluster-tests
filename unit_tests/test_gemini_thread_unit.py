...
<<<<<<< HEAD:unit_tests/test_gemini_thread_unit.py
from unit_tests.dummy_remote import LocalLoaderSetDummy
||||||| parent of 4b1bc03a8 (feature(tester): run gemini through run_stress_thread in the provision test):unit_tests/unit/test_gemini_thread_unit.py
from unit_tests.lib.dummy_remote import LocalLoaderSetDummy
=======
from sdcm.sct_events import Severity
from unit_tests.lib.dummy_remote import LocalLoaderSetDummy
>>>>>>> 4b1bc03a8 (feature(tester): run gemini through run_stress_thread in the provision test):unit_tests/unit/test_gemini_thread_unit.py
