...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("https://scylladb.atlassian.net/browse/STAG-100000", False, id="non-existing-issue-url"),  # non-existing JIRA issue
    ],
)
def test_jira_issues(params, issue, opened):
    ...
    assert bool(result) == opened, f"Issue state mismatch for issue {issue}, should be {'opened' if opened else 'closed'}."
