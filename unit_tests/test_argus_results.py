...
def test_send_latency_decorator_result_to_argus():
    ...
    cycle_num = 1
    send_result_to_argus(argus_client=argus_mock, workload="mixed", name="test", description="test", cycle=cycle_num, result=result, start_time=1721564063.4528425)
    ...
    expected_calls = [
            ...
            LatencyCalculatorMixedResult(
                ...
                results=[
                    ...
                    Cell(
                        column="Overview",
                        row=row_name,
                        value="https://cloudius-jenkins-test.s3.amazonaws.com/a9b9a308-6ff8-4cc8-b33d-c439f75c9949/20240721_125838/grafana-screenshot-overview-20240721_125838-perf-latency-grow-shrink-ubuntu-monitor-node-a9b9a308-1.png",
                        status=Status.UNSET,
                    ),
                    Cell(
                        column="QA dashboard",
        ...
        call(
            ReactorStallStatsResult(
                ...
                sut_timestamp=0,
                results=[Cell(column="total", row=row_name, value=18, status=Status.UNSET), Cell(column="10ms", row=row_name, value=18, status=Status.UNSET)],
            )
        ),
    ]
