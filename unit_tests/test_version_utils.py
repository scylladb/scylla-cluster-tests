...
RPM_URL = f"{BASE_S3_DOWNLOAD_URL}/enterprise/rpm/unstable/centos/9f724fedb93b4734fcfaec1156806921ff46e956-2bdfa9f7ef592edaf15e028faf3b7f695f39ebc1-525a0255f73d454f8f97f32b8bdd71c8dec35d3d-a6b2b2355c666b1893f702a587287da978aeec22/71/scylla.repo"
        ...
        with unittest.mock.patch.object(sdcm.utils.version_utils, "get_url_content", return_value="", clear=True):
            urls = get_scylla_urls_from_repository(
                RepositoryDetails(
                    ...
                    urls=[
                        "deb [arch=amd64] http://downloads.scylladb.com/unstable/scylla/master/deb/unified/2021-06-23T10:53:35Z/scylladb-master stable main"
                    ],
                )
            )
        self.assertEqual(
        ...
        with unittest.mock.patch.object(sdcm.utils.version_utils, "get_url_content", return_value="", clear=True):
            urls = get_scylla_urls_from_repository(
                RepositoryDetails(
                    type=ScyllaFileType.DEBIAN,
                    urls=[
                        "deb [arch=amd64,arm64] http://downloads.scylladb.com/unstable/scylla/master/deb/unified/2021-06-23T10:53:35Z/scylladb-master stable main"
                    ],
                )
            )
        self.assertEqual(
