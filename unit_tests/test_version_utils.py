...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("2024.99.99-weirdnonsemver", "scylladb/scylla-enterprise-nightly"),
        ("2025.0.0-dev-0.20251217.55f4a2b75472", "scylladb/scylla-enterprise-nightly"),
        ...
        ("2025.1.0-weirdnonsemver", "scylladb/scylla-nightly"),
