    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                "2025.1",
                Distro.UBUNTU22,
                "https://s3.amazonaws.com/downloads.scylladb.com/deb/debian/scylla-2025.1.list",
            ),
            (
                "2025.1",
                Distro.CENTOS9,
                "https://s3.amazonaws.com/downloads.scylladb.com/rpm/centos/scylla-2025.1.repo",
            ),
            (
                "2025.1.1",
                Distro.UBUNTU22,
