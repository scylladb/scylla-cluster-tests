            ...
            "Hosts": [
                {
                    ...
                    "AvailableCapacity": {"AvailableInstanceCapacity": [{"AvailableCapacity": 64, "InstanceType": "i4i.large", "TotalCapacity": 64}], "AvailableVCpus": 128},
...
def test_release_retries(mock_ec2, params):
    SCTDedicatedHosts.hosts["us-east-1d"] = {"i4i.4xlarge": "h-0867aada366f84ff1"}
    mock_ec2.release_hosts.side_effect = [{"Unsuccessful": [{"Error": {"Code": "000", "Message": "error"}}]}, {"Successful": ["h-0867aada366f84ff1"]}]
