...
Alternatively, and even recommended, one can use the `manager_branch` parameter to just choose the desired branch. Branch options can be view in defaults/manager_versions.yaml
