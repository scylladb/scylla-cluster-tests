...
[runbook-new-stress-tool.md](runbook-new-stress-tool.md#6-step-configuration-format).
...
`get_sequential_throttle_steps` in `performance_regression_gradual_grow_throughput.py`:
