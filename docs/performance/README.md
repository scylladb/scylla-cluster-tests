...
| I want to... | Read |
|---|---|
| Understand which performance tests exist, and which are still maintained | [test-catalog.md](test-catalog.md) |
...
| See what runs at which cadence, and where a new test fits | [pipelines-and-scheduling.md](pipelines-and-scheduling.md) |
...
(jenkins-pipelines/performance/)                      |
                                                      v
                                        test module (performance_*_test.py)
                                                      |
                     +--------------------------------+--------------------------------+
                     |                                                                 |
                     v                                                                 v
