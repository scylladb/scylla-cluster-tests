...
internet-routable Azure IPv6 is a billed Public IP resource. The trigger is `scylla_network_config`:
if any address sets `ip_type: ipv6`, the runner's own interface is created dual-stack with a routable
