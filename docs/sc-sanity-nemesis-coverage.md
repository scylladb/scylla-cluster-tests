...
| Issue | What it is |
|---|---|
| [SCYLLADB-4625](https://scylladb.atlassian.net/browse/SCYLLADB-4625) | node cannot restart after enabling audit - permanent crash loop |
| [SCYLLADB-4604](https://scylladb.atlassian.net/browse/SCYLLADB-4604) | SC writes unavailable for the whole decommission |
...
| [SCYLLADB-4671](https://scylladb.atlassian.net/browse/SCYLLADB-4671) | SC timeouts use placeholder exceptions, so drivers treat them as non-retryable |
