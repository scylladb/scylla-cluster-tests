...
| **<a name="scylla_mgmt_repo">scylla_mgmt_repo</a>**  | Url to the repo of scylla manager version to install for management tests | http://downloads.scylladb.com.s3.amazonaws.com/manager/rpm/unstable/centos/master/latest/scylla-manager.repo | SCT_SCYLLA_MGMT_REPO
...
| **<a name="monitor_branch">monitor_branch</a>**  | The port of scylla management | branch-3.0 | SCT_MONITOR_BRANCH
...
| **<a name="loader_swap_size">loader_swap_size</a>**  | Swap file size in bytes calculated by x * 1MB | 1024 | SCT_LOADER_SWAP_SIZE
