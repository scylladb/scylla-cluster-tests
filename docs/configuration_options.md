...
| **<a name="disable_read_repair_chance">disable_read_repair_chance</a>**  | cassandra-stress commands.<br>You can specify everything but the -node parameter, which is going to<br>be provided by the test suite infrastructure.<br>multiple commands can passed as a list | N/A | SCT_DISABLE_READ_REPAIR_CHANCE
