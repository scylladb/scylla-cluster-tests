...
### Performance — Performance testing, benchmarks, regression detection

| Plan | Status | File / PR |
|------|--------|-----------|
| Performance Testing Strategy | `draft` | [performance-testing-strategy.md](performance/performance-testing-strategy.md) |
...
| [Performance Testing Strategy](performance/performance-testing-strategy.md) | i8g Performance Jobs Migration | Statistical baselines simplify i8g threshold recalibration |
