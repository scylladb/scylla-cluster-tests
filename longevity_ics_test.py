...
class IcsLongevetyTest(LongevityTest):
    def _pre_create_schema_with_compaction(self, keyspace_num=1, scylla_encryption_options=None, single_column=False, compaction='IncrementalCompactionStrategy', compression=None, create_all_keyspaces_table=True):
        """
