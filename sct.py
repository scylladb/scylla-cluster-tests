...
||||||| parent of 1ad02ba41 (fix(aws-provision): report config init failures to Argus during provisioning)
    try:
        params = init_and_verify_sct_config()
...
=======
    ...
    try:
        ...
        test_config.set_test_id_only(test_id)
        localhost = LocalHost(user_prefix=params.get("user_prefix"), test_id=test_config.test_id())
>>>>>>> 1ad02ba41 (fix(aws-provision): report config init failures to Argus during provisioning)
