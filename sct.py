...
def list_resources(ctx, user, test_id, get_all, get_all_running, verbose, backend_type, xcloud_envs):  # noqa: PLR0912, PLR0914, PLR0915
    ...
    def extract_short_test_id_from_name(name: str) -> str:
        ...
        Returns 'N/A' if no test ID pattern is found.
        """
    ...
    def list_resources_on_xcloud():
        ...
        environments = list(xcloud_envs) if xcloud_envs else ['lab', 'staging']
            ...
            try:
                ...
                if clusters:
                    ...
                    for cluster in clusters:
                        ...
                        if test_id:
                            if short_test_id != 'N/A' and not test_id.startswith(short_test_id):
                                continue
                        if user:
