...
from sdcm.utils.argus import argus_offline_collect_events, get_argus_client, get_argus_use_tunnel_from_env
...
from sdcm.utils.aws_utils import is_using_aws_mock
...
def perf_regression_report(es_id, emails, es_index, extra_jobs_to_compare):
    ...
    results_analyzer = PerformanceResultsAnalyzer(
        es_index=es_index, es_doc_type="test_stats", email_recipients=emails, logger=LOGGER
    )
...
def send_email(  # noqa: PLR0914, PLR0912
    ...
    if reporter := test_results.get("reporter", ""):
        ...
        reporter = BaseResultsAnalyzer(es_index=test_id, es_doc_type="test_stats", email_recipients=email_recipients)
